...
def run_env(cfg: DictConfig):
    ...
    envs.disassemble_plug_from_socket_error_state(ctrl_tgt_pos,ctrl_tgt_quat, ctrl_plug_pos, ctrl_plug_quat)
    ...
    for t in range(50):
        ...
        for i in range(10):
            ...
            #     next_tgt_pose[:,2] = next_tgt_pose[:,2] + 0.002
