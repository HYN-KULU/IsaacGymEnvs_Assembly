...
def run_env(cfg: DictConfig):
    ...
    # ckpt_path = "/home/ubuntu/automate/IsaacGymEnvs_Assembly/logs/automate/flow_diffusion_policy_multitask_00681/policy_epoch_200.ckpt"  # or policy_last.ckpt
    # ckpt_path = "/home/ubuntu/automate/IsaacGymEnvs_Assembly/logs/automate/flow_diffusion_policy_multitask/policy_epoch_50.ckpt"  # or policy_last.ckpt
    ckpt_path = "/home/ubuntu/automate/IsaacGymEnvs_Assembly/logs/automate/flow_diffusion_policy_flow_cond_00681_retry/policy_epoch_200.ckpt"  # or policy_last.ckpt
    # ckpt_path = "/home/ubuntu/automate/IsaacGymEnvs_Assembly/logs/automate/diffusion_policy_flow_cond/policy_epoch_600.ckpt"  # or policy_last.ckpt
    ...
    # ckpt = torch.load("/home/ubuntu/automate/IsaacGymEnvs_Assembly/logs/automate/flow_net_multitask_ckpt/epoch_00731_15.pt", map_location=device)
    ckpt = torch.load("/home/ubuntu/automate/IsaacGymEnvs_Assembly/logs/automate/flow_net_multitask_ckpt/multi_2_epoch_100.pt", map_location=device)
    ...
    for t in range(160):
        ...
        rotated_depth_list=[]
        for i in range(12):
        # for i in range(envs.success_env_ids.shape[0]):
        ...
        try:
            ...
            import pdb; pdb.set_trace()
            # print("Runtime Error in diffusion sampling, skip this step")
            # continue
        ...
        delta_pos = init_plug_pos_2d - plug_pos_2d
        delta_pos[:,2] = -0.0008
        delta_pos[:,0] = delta_pos[:,0] / 10.0
        delta_pos[:,1] = delta_pos[:,1] / 10.0
