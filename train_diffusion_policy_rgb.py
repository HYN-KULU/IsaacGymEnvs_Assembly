...
from policy.diffusion_policy_rgb import Diffusion_Policy   # the class we wrote
...
def train(args_override):
    ...
    dataset = DepthActionDataset(args.data_path, obs_dir=args.obs_dir)
    ...
    for epoch in range(args.resume_epoch + 1, args.num_epochs):
        ...
        for batch in pbar:
            rgb = batch["rgb"].to(device)               # (B, 1, H, W)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', type=str, default="processed_dataset_rgb_absolute_actions.h5", help="HDF5 dataset path")
    parser.add_argument('--obs_dir', type=str, default="", help="obs dir")
