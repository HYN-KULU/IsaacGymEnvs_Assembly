...
class DepthActionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        data = np.load(f"/home/ubuntu/automate/IsaacGymEnvs_Assembly/data/flow_diffusion_policy/flow_depth_action_{idx}.npz", allow_pickle=False)
        flow = data["flow"].copy()
...
def main():
    dataset = DepthActionDataset(hdf5_file="/home/ubuntu/automate/IsaacGymEnvs_Assembly/processed_dataset_flow_diffusion_policy_00681.h5")
    ...
    for batch in loader:
        ...
        print("Batch proprioception shape: ",batch["proprioception"].shape)
